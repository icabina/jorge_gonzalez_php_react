...
<body class="panel">
    ...
    <div class="fila">
        <div class="cols acciones">
            <div class="col col_1">
                ...
                <a href="panel/trayectoria/edit/<?php echo $ID_trayectoria; ?>#block-fotos" class="btn_admin_atras"
                    title="Atrás">Atrás</a>
            </div>
        </div>
    </div>
    ...
    <div class="fila">
        <div class="cols">
            <div class="col col_1">
                <form action="panel/trayectoria_foto/<?php echo $accionSubmit; ?>" method="post" target="_self"
                    ...
                    <div class="fila">
                        ...
                        <?php if($ID_foto != '0'){ ?>
                        <h5 class="nombre_archivo"><?php echo $grande; ?></h5>
                        <img src="datas/<?php echo $grande; ?>" class="notanalta">


                        <input name="foto_grande" type="file">


                        <input name="foto_grande_anterior" type="hidden" value="<?php echo $grande; ?>">
                        <input name="foto_mini_anterior" type="hidden" value="<?php echo $mini; ?>">
