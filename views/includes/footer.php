...
<script src="<?php echo URL_BASE; ?>views/js/jquery-3.4.1.min.js"></script>
<script src="<?php echo URL_BASE; ?>views/js/anime-master/lib/anime.min.js"></script>
<!--<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.js"></script>-->
<!--<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/2.0.2/anime.js"></script>-->
<script src="<?php echo URL_BASE; ?>views/js/scripts.js"></script>
<script src="<?php echo URL_BASE; ?>views/js/animations.js"></script>